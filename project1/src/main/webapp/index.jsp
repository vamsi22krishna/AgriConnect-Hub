                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top product-img" src="https://m.media-amazon.com/images/I/41cFFKDT7ES._AC_UF1000,1000_QL80_.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">PlantoGallary <br> Organic Fertilizer</h5>
                                    <!-- Product price-->
                                    &#8377; 199
                                </div>
                            </div>
                    ...
                    <div class=" col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top product-img" src="https://5.imimg.com/data5/SELLER/Default/2023/5/310737065/QP/FE/WW/184544858/pottesium-schoenite-water-soluble-mix-fertilizers-brand-name-agriexa--500x500.png" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Capital Agriexa</h5>
                                    <!-- Product reviews-->
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top product-img" src="https://i.pinimg.com/236x/21/96/3e/21963ebe63871d917b020c5addb45d7b.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Penington</h5>
                                    <!-- Product price-->
                                    &#8377; 3600
                                </div>
                            </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top product-img" src="https://m.media-amazon.com/images/I/81Fcu2M2JZL._AC_UF1000,1000_QL80_.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Green Way Biotech</h5>
                                    <!-- Product reviews-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">fertilizer 4</h5>
                                    <!-- Product price-->
